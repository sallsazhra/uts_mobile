    ...
    <div role="main" class="ui-content jqm-content jqm-fullwidth">
    	...
    	<h1
            style="text-align: center;
                   font-weight:bold; 
                   text-transform: uppercase;">Input Data Karyawan</h1>

        <p></p>
		<div data-demo-html="#panel-responsive-page1" style="justify-content: center;">
        <form class="userform" method="post" action="<?php echo base_url('index.php/C_karyawan/Insert');?>">

            <label for="name">Nama Karyawan:</label>
            <input type="text" name="nama_karyawan" id="nama_karyawan" value="" data-clear-btn="true" data-mini="true" required>
