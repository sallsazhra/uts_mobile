    ...
    <?php foreach ($data as $dt);?>
    	...
    	<h1
            style="text-align: center;
                   font-weight:bold; 
                   text-transform: uppercase;">Edit Data Anggota</h1>

        <p></p>
		<div data-demo-html="#panel-responsive-page1" style="justify-content: center;">
        <form class="userform" method="post" action="<?php echo base_url('index.php/C_anggota/Update')?>">

            <label for="name">Nama Anggota:</label>
            <input type="hidden" value="<?php echo $dt->kode;?>" name="kode">
            <input type="text" name="nama" kode="nama" value="<?php echo $dt->nama;?>">
            <label for="name">Telp Anggota:</label>
            <input type="text" name="telp" kode="telp" value="<?php echo $dt->telp;?>">
            

            <div class="ui-grid-a" style="justify-content: center;">
                <div class="ui-block-a"><a href="<?php echo base_url('index.php/C_anggota/lihat');?>" data-rel="close" class="ui-btn ui-shadow ui-corner-all ui-btn-b ui-mini">Lihat</a></div><br>
                ...
                <div class="ui-block-a"><a href="<?php echo base_url('index.php/C_anggota/Hapus/').$dt->kode;?>" data-rel="close" class="ui-btn ui-shadow ui-corner-all ui-btn-b ui-mini">Hapus</a></div><br>
